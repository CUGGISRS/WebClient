...
public class ServiceAuthUtil{
    ...
    public void refreshAllowedClient() {
        ...
        String cId=serviceAuthConfig.getClientId();
        String cSecret=serviceAuthConfig.getClientSecret();
        BaseResponse resp = serviceAuthFeign.getAllowedClient(cId, cSecret);
    ...
    public void refreshClientToken() {
        ...
        BaseResponse resp = serviceAuthFeign.getAccessToken(clientId,secret );
        if (resp.getStatus() == 200) {
