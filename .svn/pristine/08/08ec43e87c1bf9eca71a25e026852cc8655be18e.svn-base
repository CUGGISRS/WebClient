  ...
  <div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column align="center" label="种植基地名称" min-width="120">
          <template slot-scope="scope">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="基地名称:" prop="baseId">
              <el-select v-model="row.baseId" clearable placeholder="请选择种植基地">
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        baseId: [{ required: true, message: '请选择种植基地', trigger: 'blur' }],
  ...
  methods: {
    ...
    editProductRow(row) {
      ...
      if (row.certificateList && row.certificateList.length !== 0) {
