...
public class EntityUtils {
    ...
    public static <T> void setCreateInfo(T entity) {
        ...
        String name = "";
        String id = "";
        analisysRequest(request, hostIp, name, id);
     ...
     * @date 2019年8月15日
     */
    public static <T> void analisysRequest(HttpServletRequest request, String hostIp, String name, String id) {
     ...
     *
     * @param text 文本
     * @return 返回使用“uft-8”编码encode后的name
     * @author 邵世尧
     * @date 2019年8月15日
     */
    public static <T> String decode(String text) {
        try {
