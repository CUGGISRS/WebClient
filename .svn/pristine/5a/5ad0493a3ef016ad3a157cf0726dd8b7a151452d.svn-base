...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-9c31f76e', './Cartesian2-cb461156', './Transforms-4d469d4c', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './ComponentDatatype-607c9a0c', './GeometryAttribute-b43261ff', './GeometryAttributes-90846c5f', './IndexDatatype-0dca33ea', './GeometryOffsetAttribute-9c676324', './EllipsoidOutlineGeometry-1d54a41c'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, EllipsoidOutlineGeometry) { 'use strict';
