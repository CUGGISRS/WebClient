    ...
    Cesium.TerrainClipPlan = function () {
        ...
        return n(e, [{
            ...
            value: function (a, b, c) {
                ...
                b = Cesium.Cartographic.fromCartesian(b);
                c = Cesium.Cartographic.fromCartesian(c);
                let n = new Cesium.Cartesian3(a.longitude - b.longitude, a.latitude - b.latitude, 0);
                let m = new Cesium.Cartesian3(c.longitude - b.longitude, c.latitude - b.latitude, 0);
                if (n.y >= 0) {
                    if (m.y >= 0) {
                        if (m.x >= n.x) {
                            return false;
            ...
            value: function (e) {
                ...
                var t = [],
                    i = e.length;
                n = this.isClockwise(e[0], e[1], e[2]), this.excavateMinHeight = 9999;
                for (var r = 0; r < i; ++r) {
                    var s = (r + 1) % i,
            ...
            key: "clear",
            value: function () {
                this.viewer.scene.globe.clippingPlanes && (this.viewer.scene.globe.clippingPlanes.enabled = !1, this.viewer.scene.globe.clippingPlanes.removeAll()), this.viewer.scene.globe.clippingPlanes = void 0, this.bottomSurface && this.viewer.scene.primitives.remove(this.bottomSurface), this.wellWall && this.viewer.scene.primitives.remove(this.wellWall), delete this.bottomSurface, delete this.wellWall, this.viewer.scene.render()
            }
        }, {
            key: "_prepareWell",
            value: function (e) {
                ...
                if (0 != i) {
                    ...
                    c = Cesium.Cartographic.fromCartesian(e[0]),
                        h = [c.longitude, c.latitude],
