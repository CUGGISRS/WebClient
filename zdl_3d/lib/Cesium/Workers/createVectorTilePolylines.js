...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-9c31f76e', './Cartesian2-cb461156', './WebGLConstants-95ceb4e9', './AttributeCompression-7d25f605', './IndexDatatype-0dca33ea', './createTaskProcessorWorker'], function (when, Check, _Math, Cartesian2, WebGLConstants, AttributeCompression, IndexDatatype, createTaskProcessorWorker) { 'use strict';
