(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    ? define(factory)
    : ((global = global || self),
      ((global.CesiumNavigation = global.CesiumNavigation || {}),
      (global.CesiumNavigation.umd = factory())));
})(this, function () {
  "use strict";
  ...
  var _ie8DomDefine =
    ...
    !require$$2(function () {
      return (
        Object.defineProperty(require$$1$1("div"), "a", {
          get: function () {
            return 7;
          },
        }).a != 7
  ...
  // 21.2.5.3 get RegExp.prototype.flags()
  if (require$$1 && /./g.flags != "g")
    require$$0$1.f(RegExp.prototype, "flags", {
      configurable: true,
      get: $flags,
    });
  ...
  var _functionToString = require$$0$3(
  ...
  var $toString =
    (_functionToString$1 && _functionToString) || _functionToString$1;
  ...
  var createFragmentFromTemplate = function createFragmentFromTemplate(
    htmlString
  ) {
  ...
  var toAbsoluteIndex =
    (_toAbsoluteIndex$1 && _toAbsoluteIndex) || _toAbsoluteIndex$1;
  ...
  var $keys =
    (_objectKeysInternal$1 && _objectKeysInternal) || _objectKeysInternal$1;
    ...
    if (defined$5(this.terria)) {
      ...
      switch (scene.mode) {
        ...
        default:
          ...
          var direction = Cartesian3$1.subtract(
            camera.position,
            focus,
            cartesian3Scratch
          );
          var movementVector = Cartesian3$1.multiplyByScalar(
            direction,
            relativeAmount,
            direction
          );
          ...
          if (
            defined$5(this.terria.trackedEntity) ||
  ...
  var NavigationViewModel = function NavigationViewModel(options) {
    ...
    this.enableZoomControls = defined$6(options.enableZoomControls)
      ? options.enableZoomControls
      : true;
    this.enableCompass = defined$6(options.enableCompass)
  ...
  NavigationViewModel.prototype.handleDoubleClick = function (viewModel, e) {
    ...
    camera.flyToBoundingSphere(focusBoundingSphere, {
      offset: new HeadingPitchRange(
        0, // do not use camera.pitch since the pitch at the center/target is required
        CesiumMath.PI_OVER_TWO -
          Cartesian3$2.angleBetween(surfaceNormal, camera.directionWC), // distanceToBoundingSphere returns wrong values when in 2D or Columbus view so do not use
  ...
  function initialize(viewerCesiumWidget, options) {
    ...
    var cesiumWidget = defined$7(viewerCesiumWidget.cesiumWidget)
    ...
    if (
      !defined$7(this.terria.options.enableDistanceLegend) ||
    ...
    if (
      (!defined$7(this.terria.options.enableZoomControls) ||
        this.terria.options.enableZoomControls) &&
      (!defined$7(this.terria.options.enableCompass) ||
